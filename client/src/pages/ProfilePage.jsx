			...
			<div className="md:col-span-1">
				<div className="bg-slate-800/60 border border-slate-700 rounded-xl p-4">
					<div className="flex flex-col items-center gap-3">
						<div className="w-32 h-32 rounded-full overflow-hidden ring-2 ring-emerald-500/50">
							{student.avatar ? (
						...
						<label className="inline-flex items-center gap-2 text-sm cursor-pointer">
							...
							<span className="px-3 py-1 rounded bg-slate-700 hover:bg-slate-600 inline-flex items-center gap-2"><FaUpload /> تحديث الصورة</span>
						</label>
					</div>
				</div>
			</div>
